...
\subsection{Mathematical Overview of the Models}
    ...
    \begin{equation*}
        X^TX \theta = X^Ty
    \end{equation*}
    where $X$ is the training data matrix, $\theta$ is the coefficient vector and $b$ is the training output. The parameter vector is then used in the sigmoid function $ \sigma(z): \mathbb{R}\to [0,1]$ defined by
    \begin{equation*}
...
As of itself the dicition tree tends to have unsatisfying results which leads to methodes like random forest that boost its accuracy.
    ...
    \begin{figure}[htbp]
        ...
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{tex/NYkNNtest1.png}
        ...
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{tex/NYkNNtest2.png}
